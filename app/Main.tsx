        ...
        <ul className="grid grid-cols-1 border-t border-l border-black md:grid-cols-2 dark:border-gray-700">
          ...
          {posts.slice(0, MAX_DISPLAY).map((post) => {
            ...
            return (
              <li
                key={slug}
                className="group border-r border-b border-black p-6 hover:bg-black dark:border-gray-700"
              >
                <article>
                  <div className="flex flex-col">
                    <dl>
                      <dt className="sr-only">Published on</dt>
                      <dd className="text-base leading-6 font-medium text-gray-500 group-hover:text-white dark:text-gray-400">
                      ...
                      <div className="space-y-6">
                        <div>
                          <h2 className="text-2xl leading-8 font-bold tracking-tight">
                            <Link
                              href={`/blog/${slug}`}
                              className="text-gray-900 group-hover:text-white dark:text-gray-100"
                            >
                              {title}
                            </Link>
                          </h2>
                        ...
                        <div className="prose max-w-none text-gray-500 group-hover:text-white dark:text-gray-400">
                          {summary}
                        </div>
                      </div>
