...
tags: ['tech']
draft: false
summary: React의 Reconciliation 과정에 대해 알아봅니다.
---
...
이름들의 목록을 상상해보자. 목록 끝에 이름을 추가하면 어떨까? React는 먼저 첫번째 item을 비교하고 두 item이 동일하다는 것을 인식한다. 그런 다음, 세번째 item이 새 item을 알아차리고 just 삽입한다. **_심플-!_**
